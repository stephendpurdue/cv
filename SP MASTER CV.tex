...
\begin{center}
    ...
    \small{-}
    \href{[url to linkedin profile]}{ \color{blue}{linkedin.com/in/stephenpurdue}}  ~
    \small{-}
    \href{[url to github profile]}{ \color{blue}{github.com/stephendpurdue}} ~
    \vspace{-7pt}
\end{center}
...
\section{\color{airforceblue}EDUCATION}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science - Artificial Intelligence}{Sep 2026 - Sep 2027}
    \vspace{-2pt}
     \resumeSubheading
      {University of Winchester}{Winchester, UK}
      {Bachelor of Science - Game Development}{Sep 2023 - May 2026}
